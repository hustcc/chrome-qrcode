...
function showResult(dom, base64, text) {
    if (base64) {
        dom.innerHTML = '<div style="margin:0;font-family:\'Source Sans Pro\', \'Microsoft Yahei\',sans-serif,Arial; font-size:14px;color:black;position:fixed;top:0;right:0;bottom:0;left:0;background:#f1f1f1;background:rgba(0,0,0,0.39);z-index:99999" onclick="this.parentNode.innerHTML=\' \';"></div>' + 
                        '<div style="margin:0;font-family:\'Source Sans Pro\', \'Microsoft Yahei\',sans-serif,Arial; font-size:14px;color:black;position:fixed;top:80px;left:50%;margin-left:-121px;padding:10px 10px;width:260px;border:1px solid #d9d9d9;background:#fff;text-align:center;z-index:100000;">' + 
                            '<a href="javascript:;" onclick="this.parentNode.parentNode.innerHTML=\' \';" style="text-decoration:none;color:#666;position:absolute;top:5px;right:10px;display:block;width:20px;height:20px;font-size:20px;cursor:pointer">×</a>' + 
